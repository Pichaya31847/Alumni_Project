...
include "connect_server.php";
    ...
    if (!empty($_FILES['file']['tmp_name'][0])){
        ...
        $sql = "UPDATE commu_info SET news_header = '$news_header', new_desscri = '$new_desscri' WHERE id_post = '$id_post'";
    ...
    if($result_img){
        $sql_img_up = "UPDATE commu_info SET news_header = '$news_header', new_desscri = '$new_desscri' WHERE id_post = '$id_post'";
