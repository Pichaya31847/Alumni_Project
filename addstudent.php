                        ...
                        <div class="details personal">
                            ...
                            <div class="fields">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="id_student" placeholder="0000000000000" required>
                                </div>

                                <div class="input-field">
                                    <label>คำนำหน้านาม</label>
                                    <input type="text" name="name_prefix" placeholder="นาย/นาง/นางสาว และ อื่นๆ"
                                        required>
                                </div>

                                <div class="input-field">
                                    <label>ชื่อ - นามสกุล</label>
                                    <input type="text" name="name_student" placeholder="นาย ดี โรเจอร์" required>
                                </div>

                                <div class="input-field">
                                    <label>ชื่อเล่น</label>
                                    <input type="text" name="name_nickname" placeholder="ชื่อเล่น เช่น บิ๊ก" required>
                                </div>

                                <div class="input-field">
                                    <label>วัน เดือน ปีเกิด</label>
                                    <input type="date" name="date_birth" placeholder="#" required>
                                </div>

                                <div class="input-field">
                                    <label>ภูมิลำเนา (จังหวัด)</label>
                                    <input type="text" name="location_home" placeholder="จังหวัดที่่อยู่ปัจจุบัน"
                                        required>
                                </div>

                                <div class="input-field">
                                    <label>เบอร์โทรศัพท์</label>
                                    <input type="text" name="tel_student" placeholder="0800000000" maxlength="10"
                                        required>
                                </div>

                                <div class="input-field">
                                    <label>อีเมล</label>
                                    <input type="text" name="email_student" placeholder="Enter your Email" required>
                                </div>

                                <div class="input-field">
                                    <label style="font-size:13px">ลิงค์ URL หรือ ชื่อใน facebook</label>
                                    <input type="text" name="facebook_student" placeholder="url facebook" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="details ID">
                            <div class="fields">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="line_student" placeholder="ID LINE" required>
                                </div>

                                <div class="input-field"><br>
                                    <label style="margin-top: 24px;">ปีที่จบการศึกษา</label>
                                    <input type="text" name="dath_end" placeholder="25xx" required>
                                </div>

                                <div class="input-field">
                                    <label>เกรดเฉลี่ยสะสมทุกภาคการศึกษา (GPAX)</label>
                                    <input type="number" name="grade_student" placeholder="GPAX" required>
                                </div>

                                <div class="input-field">
                                    <label>มีความสนใจ / เชี่ยวชาญ เรื่องใด</label>
                                    <input type="text" name="like_student" placeholder="มีความสนใจด้านไหน" required>
                                </div>

                                <div class="input-field">
                                    <label>หลักสูตรที่ท่านกำลังศึกษา หรือ สำเร็จการศึกษา</label>
                                    <input type="date" name="majoy_end" placeholder="#" required>
                                </div>


                                <div class="input-field">
                                    <label>สถานที่ทำงานปัจจุบัน หรือยังไม่ได้ทำงาน</label>
                                    <input type="text" name="work_typt" placeholder="สถานที่ทำงาน" required>
                                </div>

                                <div class="input-field"><br>
                                    <label style="margin-top: 24px;">ชื่อสถานที่ทำงานปัจจุบัน</label>
                                    <input type="text" name="work_name" placeholder="ชื่อสถานที่ทำงานล่าสุด" required>
                                </div>

                                <div class="input-field">
                                    <label>ตำแหน่งงาน / หน้าที่รับผิดชอบ</label>
                                    <input type="text" name="position_typt" placeholder="ตำแหน่งงาน" required>
                                </div>

                                <div class="input-field">
                                    <label>เงินเดือนที่ได้รับ</label>
                                    <input type="text" name="salary_work" placeholder="เงินเดือน" required>
                                </div>
                                <div class="details">
                                    <label></label>
                                    <div class="buttons" style="width: 171px;">
