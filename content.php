...
<body style="background-color: #f5f5f5;" s>
    ...
    <div class="container">
        <div class="d-flex flex-column"
            style="background: white; border: 1px solid #e0e0e0e0; margin-top: 10px; border-radius: 10px;">
            ...
            <div class="d-flex mx-4 my-3">
                <div>
                    <p style="font-family: 'Kanit', sans-serif;"><?php print $row_edit["new_desscri"]; ?></p>
                </div>
            </div>
            <div class="d-flex mx-4 my-3">
                <div><?php
                                        $id_pic_post = $row_edit["id_post"];
                                        $sql_pic_post = "SELECT * from $index_user where id_post like '$id_pic_post' ";
                                        $result_pic_post = $conn->query($sql_pic_post);
                                        while ($row_pic_post = $result_pic_post->fetch_assoc()) {
                                        ?>
                    <img src="upload/<?php print $row_pic_post['picture_name']; ?>" style="height: 640px;"><hr>
                    <?php } ?>
                </div>
            </div>
