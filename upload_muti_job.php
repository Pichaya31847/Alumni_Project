...
$sql = "INSERT INTO job_info (id_post,news_header,new_desscri,date_news,new_position,news_member,new_contract) values ('$id_post','$news_header','$new_desscri','$dath_news','$new_position','$news_member','$new_contract')";
