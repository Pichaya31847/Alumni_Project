...
?>
        ...
        <body>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="margin-top: calc(2vh + 50%);">
                        ...
                        <div class="modal-body">
                            <form enctype="multipart/form-data" method="POST" action="upload_muti_new.php">
            ...
            <?php if (!empty($_GET["id_post"])) {
                ...
                $sql_edit = "SELECT * from news_info where id_post like '$id_post' ";
                    ...
                    <div class="container_edit">
                        <div>
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        <h3>แก้ไขข่าวประชาสัมพันธ์</h3>
                                    </h5>
                                    <button type="button" class="close">
                                        <a href="news-input.php?page=<?php print $page ?>"><span aria-hidden="true">&times;</span></a>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form enctype="multipart/form-data" method="POST" action="update_muti_new.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="flex-container wrap">
                                                ...
                                                $sql_pic_post = "SELECT * from picture_news where id_post like '$id_pic_post' ";
                                                $result_pic_post = $conn->query($sql_pic_post);
                                                while ($row_pic_post = $result_pic_post->fetch_assoc()) {
                                                ?>
                                                    <li class="flex-item">
                                                        <div class="delete_text"><a href="delpicture_news.php?id=<?php print $row_pic_post['id']; ?>&id_post=<?php print $row_edit['id_post']; ?>&page=<?php print $page ?>" onclick="return confirm('ยืนยันที่จะลบรูปภาพนี้ไหม');">ลบ</a></div><img src="upload/<?php print $row_pic_post['picture_name']; ?>" height="80">
                                                    </li>
                                                <?php } ?>
                                            </div>
                                            <!-- end image -->
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"><a href="news-input.php?page=<?php print $page ?>" style="color: white;">Close</a></button>
            ...
            <div class="container">
                <div class="header_contain">
                    <div class="content_left">
                        <div class="content_left_up">
                            <add style="font-size: 30px;font-weight:600">ข้อมูลข่าวประชาสัมพันธ์</add>
                        </div>
                    ...
                    <div class="content_right">
                        <div class="content_right_up">
                            <label data-toggle="modal" data-target="#exampleModal"><a href="#">+ เพิ่มข่าวประชาสัมพันธ์</a></label>
                        </div>
                ...
                $sql = "SELECT * from news_info where news_header like '%$search%' ORDER BY date_news DESC limit $start_from,$num_per_page ";
                ...
                ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="header_new" width="25">
                                        <p class="post-meta">
                                            <time datetime="2022-05-26" pubdate=""><a href="news-input.php?id_post=<?php print $row['id_post']; ?>&page=<?php print $page ?>">แก้ไข</a></time>
                                        </p>
                                    </td>
                                    <td class="header_new" width="25" align="right">
                                        <p class="post-meta">
                                            <time datetime="2022-05-26" pubdate=""><a href="del_news.php?id_post=<?php print $row['id_post']; ?>&page=<?php print $page ?>" onclick="return confirm('ยืนยันที่จะลบโพสต์นี้ไหม');">
                                ...
                                <tr>
                                    <?php
                                    $id_post = $row["id_post"];
                                    $sql_pic = "SELECT * from picture_news where id_post like '$id_post' ";
                    ...
                    <div class="d-flex m-4 justify-content-center ">
                        <div class="navigation">
                            <!--  ปุ่มกดไปหน้าแรกสุด  -->
                            <?php if ($page > 2) { ?>
                                <a class="next page-numbers" href="news-input.php?page=1&search=<?php print $search; ?>">&laquo;</a>
                            <?php } ?>

                            <!--  ปุ่มกดไปหน้าก่อน  -->
                            <?php if ($page > 1) { ?>
                                <a class="next page-numbers" href="news-input.php?page=<?php print($page - 1); ?>&search=<?php print $search; ?>">&lt;</a>
                            <?php } ?>
                            ...
                            <?php if ($page > 2) {
                                $pree_page = $page - 2; ?>
                                <a class="page-numbers" href="news-input.php?page=<?php print($page - 2); ?>&search=<?php print $search; ?>"><?php print $pree_page; ?></a>
                            <?php } ?>

                            <?php if ($page > 1) {
                                $pree_page = $page - 1; ?>
                                <a class="page-numbers" href="news-input.php?page=<?php print($page - 1); ?>&search=<?php print $search; ?>"><?php print $pree_page; ?></a>
                            <?php } ?>
                            ...
                            <!--  ปุ่มกดไปหน้าสุดท้าย  -->
                            <?php if (($page < $total_pages)) { ?>
                                <a class="next page-numbers" href="news-input.php?page=<?php print($total_pages); ?>&search=<?php print $search; ?>">&raquo;</a>
                            <?php } ?>
